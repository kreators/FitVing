...
class AboutTortoiseViewController: UIViewController, WKNavigationDelegate {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        webView.load(URLRequest(url: URL(string: "http://www.newtortoise.com/about")!))
    }
    ...
    fileprivate func initUI() {
        ...
        self.navigationItem.title = "About Tortoise"
